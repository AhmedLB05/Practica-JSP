...
<head>
    ...
    <title>Editar Perfil - Polideportivo Martos</title>
...
<div class="card">
    ...
    <form method="post" action="EditarPerfilServlet">
        ...
        <label>Email</label>
        <label>
            <input type="email" name="email" value="<%= usuario.getEmail() != null ? usuario.getEmail() : "" %>">
        </label>

        <label>Teléfono</label>
        <label>
            <input type="tel" name="telefono" value="<%= usuario.getTelefono() != null ? usuario.getTelefono() : "" %>">
        </label>
